...
io.sockets.on('connection', function(socket)
{
	...
	socket.on("register", function(data)
	{
		...
		{
			users[data.username.toLowerCase()] = [data.username, superEncrypt(privateKey.decrypt(data.password), data.username.toLowerCase())];
	...
	{
		if(users[data.username.toLowerCase()] === undefined);
		else if(users[data.username.toLowerCase()][1] == superEncrypt(privateKey.decrypt(data.password), data.username.toLowerCase()))
		{
